...
function CountryOffline(props) {
  console.log('Rendering CountryOffline...')
  ...
  const { match } = props;
  console.log(match);
  let countryName = match.params.name.toLowerCase();
  
  let country = countries.filter(country => country.name.common.toLowerCase() === countryName);
